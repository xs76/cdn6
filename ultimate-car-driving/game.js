function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Ultimate_Car_Driving.loader.js";
		var config = {
        dataUrl: buildUrl + "/Ultimate_Car_Driving.data",
        frameworkUrl: buildUrl + "/Ultimate_Car_Driving.framework.js",
        codeUrl: buildUrl + "/Ultimate_Car_Driving.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "UBG365",
        productName: "Ultimate_Car_Driving",
        productVersion: "1.0",
      };
