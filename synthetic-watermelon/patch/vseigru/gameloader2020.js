...
_0x201b) && (version_ = _0x13fa0c(0x21f, '1Pms'));
function _0x201b() {
...
;var disableLinks = ['dnNlaWdydS5uZXQ=', 'Zy52c2VpZ3J1Lm5ldA==', _0x13fa0c(0x194, 'I[#r'), _0x13fa0c(0x202, 'RI*2')]
  ...
  , ref = document[_0x13fa0c(0x139, '6PhN')]['replace'](/^https?:\/\//, '')['slice'](0x0, -0x1)
  , isOnOurWeb = externalLinksCheck(disableLinks)
  , loaderLang = ''
  , loaderLangText = {
    'ru': {
        'logo': _0x13fa0c(0x1e7, 'kNPe'),
        'fileLoadingTxt': 'Загрузка\x20файлов:\x20',
        'gameLoadingTxt': _0x13fa0c(0x230, 'cizB'),
        'moreGamesTxt': 'Больше\x20игр\x20»',
        'moreGamesLink': _0x13fa0c(0x195, '8N#!')
    },
    'en': {
        'logo': '<div\x20class=\x22jss125\x22><span><span\x20class=\x22jss122\x22>G</span><span\x20class=\x22jss123\x22>AME</span><span\x20class=\x22jss124\x22>I</span><span\x20class=\x22jss123\x22>S</span></span><span\x20class=\x22jss128\x20jss129\x22></span><span\x20class=\x22jss131\x20jss133\x22\x20style=\x22display:\x20inline;\x22>.NET</span></div>',
        'fileLoadingTxt': 'Downloading\x20files:\x20',
        'gameLoadingTxt': _0x13fa0c(0x1b0, '[Lj1'),
        'moreGamesTxt': _0x13fa0c(0x201, 'YK1k'),
        'moreGamesLink': _0x13fa0c(0x17f, 'mrZI')
    },
    'uk': {
        'logo': _0x13fa0c(0x14c, 'ESjW'),
        'fileLoadingTxt': _0x13fa0c(0x1ec, 'kNPe'),
        'gameLoadingTxt': 'Завантаження\x20гри...',
        'moreGamesTxt': 'Більше\x20ігор\x20»',
        'moreGamesLink': _0x13fa0c(0x135, '^Dg[')
    }
};
if (isOnOurWeb)
    switch (ref) {
    case _0x13fa0c(0x23a, '8N#!'):
        loaderLang = 'en';
        break;
    case _0x13fa0c(0x1ff, '9siw'):
        loaderLang = 'uk';
        break;
    default:
        loaderLang = 'ru';
    ...
    switch ((navigator[_0x13fa0c(0x1fb, '*0mO')] || navigator[_0x13fa0c(0x238, ')ecV')])['slice'](0x0, 0x2)) {
    case 'en':
        loaderLang = 'en';
        break;
    case 'uk':
            ...
            if (_0x53f87f['WLrQT'](_0x53f87f[_0x488d31(0x1d7, 'X2]^')], _0x488d31(0x158, 'cizB')))
                ...
                while (!![]) {
                    ...
                    case '4':
                        ...
                        continue;
                    case '5':
                        console.log("--fx--pageCode", pageCode);
                        pageCode= pageCode.replace("/lib/game-loader/", "./patch/vseigru/");
                        pageCode= pageCode.replace("<div class=\"game-footer\">", "<div style=\"display:none;\">");
...
var version_ = 'jsjiami.com.v7';
console.log('VseLoader v0.1 - 15.11.23');
