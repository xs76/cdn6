    ...
    this._init = function() {
        ...
        if (s_iModeGame === MODE_SNAKES) {
            ...
            var oData = {   
                ...
                frames: {width: _aWidth[s_iModeGame], height: _aHeight[s_iModeGame], regX: _aWidth[s_iModeGame]/2, regY: _aHeight[s_iModeGame]-10}, 
                animations: {0: [0,0], 
                             1: [1,1],
                             2: [2,2],
                             3: [3,3],
            ...
            var oData = {   
                ...
                framerate: 30,
                // width, height & registration point of each sprite
                frames: {width: PLAYER_SPRITE_WIDTH[_iColor], height: PLAYER_SPRITE_HEIGHT[_iColor], regX: PLAYER_SPRITE_WIDTH[_iColor]/2, regY: PLAYER_SPRITE_HEIGHT[_iColor]/2+20}, 
                animations: { idle  : [0, 26, true, 0.5], 
                              walk  : [27, 40],
