...
var OBSTACLES_MOVEMENT_SQUARES = [[16,6],[47,26],[49,11],[56,53],[62,19],[64,60],[87,24],[93,73],[95,75],[98,78]];
var LADDER_MOVEMENT_SQUARES = [[1,38],[4,14],[9,31],[21,42],[28,84],[36,44],[51,67],[71,91],[80,100]];

// This array includes the coordinates of the squares
var BOARD_SQUARES;
BOARD_SQUARES = [ [ 334, 565 ], // 0: START
                  [ 435, 565 ], // 1: LADDER
                  [ 490, 565 ],
                  [ 540, 565 ],
                  [ 600, 565 ], // 4: LADDER
...
var CHUTES_COORDS_16 = [[635.8,507.8],
                        [589.7,528.3],
                        [577.3,545.8],
                        [595.15,564.3],
                        [647.7,568.8],
                        [696.15,576.25]];
var CHUTES_COORDS_47 = [[785.25,348.3],
                        [812.15,367.8],
                        [820.25,388.3],
                        [804.1,409.3],
                        [759.65,423.8],
                        [723.65,441.75]];
var CHUTES_COORDS_49 = [[878.75,364.3],
                        [892.15,383.3],
                        [898.75,411.8],
                        [904.1,443.3],
                        [913.65,469.8],
                        [930.15,497.75]];
var CHUTES_COORDS_56 = [[666.3,276.8],
                        [702.25,276.8],
                        [729.75,286.8],
                        [759.1,295.3],
                        [798.15,295.3]];
var CHUTES_COORDS_62 = [[508.3,239.8],
                        [541.8,282.5],
                        [550.3,298.8],
                        [545.65,319.3],
                        [510.7,365.9],
                        ...
                        [548.7,480.75],
                        [501.6,519.25]];
var CHUTES_COORDS_64 = [[582.3,228.3],
                        [561.7,229.8],
                        [541.8,241.7],
                        [519.65,258.8],
                        [503.2,273.4],
                        [477.6,285.4],
                        [447.2,295.9]];
var CHUTES_COORDS_87 = [[767.75,147.3],
                        [750.15,195.5],
                        [736.75,208.9],
                        [647.65,251.3],
                        [629.2,270.9],
                        ...
                        [663.75,430.25],
                        [621.65,449.75]];
var CHUTES_COORDS_93 = [[838.75,70.85],
                        [880.65,82.5],
                        [885.15,96.9],
                        [880.65,112.3],
                        [858.7,133.9],
                        [835.6,153.4],
                        [822.2,170.9]];
var CHUTES_COORDS_95 = [[683.75,63.35],
                        [649.2,80.4],
                        [643.7,95.9],
                        [653.6,108.3],
                        [702.2,133.9],
                        [714.1,151.9],
                        [711.7,172.4]];
var CHUTES_COORDS_98 = [[516.75,62.35],
                        [482.2,79.4],
                        [476.7,94.9],
                        [486.6,107.3],
                        [535.2,132.9],
