function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'ladder',loop:false,volume:1, ingamename: 'ladder'});
        s_aSoundsInfo.push({path: './sounds/',filename:'dices',loop:false,volume:1, ingamename: 'dices'});
        s_aSoundsInfo.push({path: './sounds/',filename:'snake',loop:false,volume:1, ingamename: 'snake'});
        s_aSoundsInfo.push({path: './sounds/',filename:'eat',loop:false,volume:1, ingamename: 'eat'});
        s_aSoundsInfo.push({path: './sounds/',filename:'chute',loop:false,volume:1, ingamename: 'chute'});
