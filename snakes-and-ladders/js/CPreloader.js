function CPreloader() {
    ...
    this.attachSprites = function () {
        ...
        _oIcon.y = CANVAS_HEIGHT_HALF - 100;
        ...
        _oProgressBar.y = CANVAS_HEIGHT_HALF + 130;
        ...
        _oLoadingText = new createjs.Text("", "30px " + PRIMARY_FONT, PRIMARY_FONT_COLOR);
        _oLoadingText.x = CANVAS_WIDTH_HALF;
        _oLoadingText.y = CANVAS_HEIGHT_HALF + 180;
        _oLoadingText.textBaseline = "alphabetic";
        _oLoadingText.textAlign = "center";
        _oContainer.addChild(_oLoadingText);
        
        var oSprite = s_oSpriteLibrary.getSprite('but_start');
        _oButStart = new CTextButton(CANVAS_WIDTH_HALF, CANVAS_HEIGHT_HALF + 80, oSprite, TEXT_PRELOADER_CONTINUE, "Arial", "#000", "bold "+ 50, _oContainer);        
