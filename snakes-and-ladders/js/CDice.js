function CDice() {
    ...
    this._init = function () {
        ...
        var iStartDicePosition = {x: CANVAS_WIDTH_HALF + 400, y: CANVAS_HEIGHT};
        ...
        var oData = {   
                ...
                framerate: 24,
                frames: {width: iWidthLaunch, height: iHeightLaunch, regX: iWidthLaunch, regY: iHeightLaunch},
                animations: { stop: [8,8], idle: [0, 8, "stop"] }
            };
    ...
    this.fadeOutTween = function() {
        createjs.Tween.get(_oDice, {loop: false})
            .to({alpha: 0}, 200)
            .call(this.hide);
    };
