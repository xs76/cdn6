function CPause() {
    ...
    this._init = function () {
        ...
        var oPauseTextStroke = new createjs.Text(TEXT_PAUSE, "50px " + PRIMARY_FONT, THIRD_FONT_COLOR);
        ...
        var oPauseText = new createjs.Text(TEXT_PAUSE, "50px " + PRIMARY_FONT, PRIMARY_FONT_COLOR);
