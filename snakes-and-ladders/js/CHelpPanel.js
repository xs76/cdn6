function CHelpPanel() {
    ...
    this._init = function () {
        ...
        new createjs.Tween.get(_oAnimationLadder, {loop: true})
            .to({x: _oImageLadder.x - 25, y: _oImageLadder.y - 60}, 1000, createjs.Ease.cubicIn)
            .wait(500);
        ...
        if (s_iModeGame === MODE_SNAKES) {
            ...
            new createjs.Tween.get(_oAnimationSnake, {loop: true})
                .to({x: _oImageObstacle.x, y: _oImageObstacle.y - 15}, 300, createjs.Ease.linear)
                .to({x: _oImageObstacle.x + 25, y: _oImageObstacle.y}, 300, createjs.Ease.linear)
                .to({x: _oImageObstacle.x + 30, y: _oImageObstacle.y + 10}, 300, createjs.Ease.linear)
                .wait(500);
        } else {
            ...
            new createjs.Tween.get(_oAnimationChute, {loop: true})
                .to({x: _oImageObstacle.x, y: _oImageObstacle.y - 15}, 300, createjs.Ease.linear)
                .to({x: _oImageObstacle.x + 10, y: _oImageObstacle.y}, 300, createjs.Ease.linear)
                .to({x: _oImageObstacle.x + 35, y: _oImageObstacle.y + 15}, 300, createjs.Ease.linear)
                .wait(500);
        };
