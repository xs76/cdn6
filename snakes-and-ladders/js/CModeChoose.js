function CModeChoose() {
    ...
    this._init = function () {
        _pStartPosButtons = {x: CANVAS_WIDTH_HALF, y: CANVAS_HEIGHT_HALF + 30};
        ...
        if (DISABLE_SOUND_MOBILE === false || s_bMobile === false) {
            ...
            _pStartPosAudio = {x: CANVAS_WIDTH - (oSprite.width / 2) - 50, y: (oSprite.height / 2) + 10};
        ...
        _oButPlayMode0.addEventListener(ON_MOUSE_UP, function() { this._onButPlayRelease(MODE_SNAKES) }, this);
        ...
        _oButPlayMode1.addEventListener(ON_MOUSE_UP, function() { this._onButPlayRelease(MODE_CHUTES) }, this);

        var oSpriteExit = s_oSpriteLibrary.getSprite('but_exit');
        _pStartPosExit = {x: CANVAS_WIDTH - (oSpriteExit.height / 2) - 10, y: (oSpriteExit.height / 2) + 10};
