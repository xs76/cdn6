    ...
    ! function (a) {
        var b = function (a) {
            ...
            return __extends(b, a), b.prototype.resize = function (a) {
                ...
                b.addColorStop(0, "rgba(26, 135, 182, 1)"), b.addColorStop(.5, "rgba(25, 174, 232, 1)"), b.addColorStop(.5, "rgba(3, 114, 165, 1)"), b.addColorStop(1, "rgba(8, 147, 203, 1)"), this.gradientBitmap.context.fillStyle = b, this.gradientBitmap.context.clearRect(0, 0, this.game.width, this.game.height), this.gradientBitmap.context.fillRect(0, 0, this.game.width, this.game.height), console.log("resie", this.game.width, this.game.height)
            }, b.prototype.update = function () {}, b.prototype.destroy = function (b) {
                a.prototype.destroy.call(this, b), console.log("destroy!!"), console.trace(), this.gradientBitmap.destroy(), this.gradient.destroy(!0), this.gradientBitmap = null, this.gradient = null
            }, b
        }(Phaser.Group);
        a.Kizi = b
    }(b = a.SplashScreenBackgrounds || (a.SplashScreenBackgrounds = {}))
...
! function (a) {
    ...
    var c = function () {
        ...
        return c.preloadImages = function (b) {
            ...
            //     l = window.open(g + "/?utm_source=" + h + "&utm_medium=html5&utm_term=" + e + "&utm_content=" + k + "&utm_campaign=Gamedistribution", "_blank");
            // l.focus()
...
! function (a) {
    var b;
    ! function (a) {
        a[a.Neutral = 0] = "Neutral", a[a.Yepi = 1] = "Yepi", a[a.Spele = 2] = "Spele", a[a.Funnygames = 3] = "Funnygames", a[a.Kizi = 4] = "Kizi", a[a.PlayCell = 5] = "PlayCell", a[a.Bild = 6] = "Bild"
        ...
        var c = function (b) {
            ...
            return __extends(c, b), c.prototype.setup = function (b, c, d, e) {
                ...
                return ga("fbrq.set", "appName", "All"), ga("fbrq.send", "pageview"), window.DS_OPTIONS = {
                        id: "fbrq",
                        success: function (a) {
                            ga("fbrq.set", "userId", a), ga("fbrq.set", "dimension1", a), ga("fbrq.send", "event", "Identification", "complete")
                        }
                    },
                    function (a, b, c, d) {
                    ...
                    }(window, document, "script", "./build/main.min.js"), ga
    ...
    ! function (b) {
        var c = function (c) {
            ...
            return __extends(d, c), d.prototype.init = function (b) {
                ...
                a.Utils.isOnDevice(this.game) || a.Branding.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "/repository/download/Fabrique_FunnyGamesSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "//" + window.location.host + "/@orange-games/splash/assets/"), a.Utils.registerAudioUnlocker(this.game)
            ...
            return __extends(d, c), d.prototype.init = function (a, b) {
                ...
                if (this.scaleFactor = this.getScale(), a.Utils.isTc() || (this.game.load.crossOrigin = "anonymous"), a.Branding.isSpecial(this.game)) this.game.add.existing(this.background), this.game.load.spritesheet("fgs_play", a.Utils.ASSET_LOCATION + "images/fgs_btn_play.png", 130, 130), this.game.load.image("loader", a.Utils.ASSET_LOCATION + "images/loader_back.png");
                    ...
                    case a.BrandingDomain.Spele:
                        ...
                        break;
                    case a.BrandingDomain.PlayCell:
                        this.game.load.image("playcell_bg", a.Utils.ASSET_LOCATION + "images/playcell_splash_bg.png"), this.game.load.image("playcell_bubble", a.Utils.ASSET_LOCATION + "images/playcell_splash_bubble.png"), this.game.load.image("playcell_button", a.Utils.ASSET_LOCATION + "images/playcell_splash_button.png");
                        break;
                    case a.BrandingDomain.Yepi:
                    ...
                    default:
                    case a.BrandingDomain.Kizi:
                        this.game.load.atlas("kizi_atlas", a.Utils.ASSET_LOCATION + "atlas/kizi_atlas.png", a.Utils.ASSET_LOCATION + "atlas/kizi_atlas.json");
                        break;
                    case a.BrandingDomain.Bild:
        ...
        var c = function (c) {
            ...
            return __extends(d, c), d.prototype.init = function (a, b) {
                ...
                this.monster1 = this.game.add.spine(0, 0, "fgs_monster_1"), this.monster1.setAnimationByName(0, "idle", !0), this.monster2 = this.game.add.spine(0, 0, "fgs_monster_2"), this.monster2.setAnimationByName(0, "idle", !0), this.monster3 = this.game.add.spine(0, 0, "fgs_monster_3"), this.monster3.setAnimationByName(0, "idle", !0), this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 230, "", {
                    ...
                    fill: "#ffffff",
                    fontWeight: "bold"
                }), this.preloadText.anchor.set(.5), this.logo = this.game.add.image(0, 0, "fgs_logo"), this.logo.anchor.set(.5), d.IdealWidth = 1.5 * this.logo.getBounds().width, this.playButton = this.game.add.button(this.game.width / 2, this.game.height / 2 + 230 * this.scaleFactor, "fgs_play", this.handler, this, 0, 0, 1, 0), this.playButton.anchor.set(.5), this.playButton.scale.set(this.scaleFactor), this.playButton.visible = !1, this.created = !0
            }, d.prototype.handler = function (a, b) {
                if (!this.clicked && "mouseout" !== b.type) {
                    this.clicked = !0, this.game.tweens.remove(this.buttonTween), this.game.camera.fade(0, 250);
                    var c = this.game.add.tween(this.playButton.scale);
    ...
    ! function (b) {
        var c = function (c) {
            ...
            return __extends(d, c), d.prototype.init = function (a, b) {
                ...
                var b = this;
                this.preloadReady = !0, a.Utils.isOnDevice(this.game) ? this.game.time.events.add(Phaser.Timer.SECOND, function () {
                ...
                var a = this;
                this.clouds = this.game.add.sprite(0, 50, "kizi_atlas", "kizi_splash_bg_cloud"), this.clouds.scale.set(this.game.width / d.IdealWidth), this.clouds.alpha = .5, this.monster = this.game.add.sprite(this.game.width / 2, this.game.height / 2, "kizi_atlas"), this.monster.animations.add("load", Phaser.Animation.generateFrameNames("kizi_splash_spritesheet-", 0, 3)), this.monster.animations.play("load", 6, !0), this.monster.scale.set(1.5 * this.scaleFactor), this.monster.anchor.set(.5), this.playButton = this.game.add.button(this.game.width / 2, .75 * this.game.height, "kizi_atlas", function () {
                ...
                }, this, "kizi_splash_button", "kizi_splash_button", "kizi_splash_button_onpush", "kizi_splash_button"), this.playButton.anchor.set(.5), this.playButton.scale.set(.6 * this.scaleFactor), this.playButton.visible = !1, this.created = !0
            }, d.prototype.resizeObjects = function () {
                this.created && (a.Utils.isOnDevice(this.game) || (console.log("resizing"), this.monster.scale.set(1.5 * this.scaleFactor), this.monster.position.set(this.game.width / 2, this.game.height / 2), this.clouds.position.set(0, 50), this.clouds.scale.set(this.game.width / d.IdealWidth), this.playButton.scale.set(.6 * this.scaleFactor), this.playButton.x = this.game.width / 2, this.playButton.y = this.game.height / 2 + this.monster.height / 2 - this.playButton.height / 2))
                ...
                a.Utils.isOnDevice(this.game) || (this.game.tweens.remove(this.buttonTween), this.playButton.scale.set(.6 * this.scaleFactor), this.playButton.visible = !0, this.buttonTween = this.game.add.tween(this.playButton.scale), this.buttonTween.to({
                    x: 1.14 * this.scaleFactor * .6,
                    y: 1.14 * this.scaleFactor * .6
                }, 420, Phaser.Easing.Quadratic.InOut, !0, 500), this.buttonTween.yoyo(!0).onComplete.add(this.animateButton, this), this.buttonTween.start())
            }, d.prototype.update = function () {}, d.prototype.loadUpdate = function () {}, d.prototype.resize = function () {
                this.scaleFactor = this.getScale(), this.background.resize(this.scaleFactor), this.monster.scale.set(this.scaleFactor), this.resizeObjects(), this.created && this.preloadReady && this.animateButton()
            }, d.prototype.shutdown = function () {
        ...
        c.Name = "kiziSplashScreen", c.IdealWidth = 1279, c.MaxDots = 3, b.Kizi = c
    }(b = a.SplashScreen || (a.SplashScreen = {}))
}(Fabrique || (Fabrique = {}));
var Fabrique;
! function (a) {
    ...
    ! function (a) {
        var b = function (b) {
            function c() {
                ...
                return a.name = c.Name, a.scaleFactor = 1, a.width = 787, a.height = 494, a.created = !1, a.preloadTexts = [], a.preloadReady = !1, a.balls = [], a.clicked = !1, a.tId = 0, a
            }
            return __extends(c, b), c.prototype.init = function (a, b) {
                ...
                Date.now() - this.t > 2e3 && (this.t = Date.now(), this.tId++, this.tId >= this.preloadTexts.length && (this.tId = 0)), this.preloadText.setText("Spelletje wordt geladen")
            }, c.prototype.onPreloadEnd = function () {
                this.preloadReady = !0, this.preloadText.visible = !1, this.game.input.onUp.add(this.handler, this), this.game.tweens.removeAll(), this.balls.forEach(function (a) {
                ...
                this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 150, "", {
                    ...
                    for (var b = 0; b < 3; b++) {
                        ...
                        c.alignIn(a.game.world.bounds, Phaser.CENTER, -50 + 100 * b, 150), c.scale.set(0), c.anchor.set(.5), a.balls.push(c), a.game.add.tween(c.scale).to({
                            x: 1,
                            y: 1
                ...
                b.prototype.shutdown.call(this), this.playButton.destroy(!0), this.background.destroy(!0), this.preloadText.destroy(!0), this.playButton = null, this.bg = null, this.background = null, this.preloadText = null, this.game.scale.onSizeChange.remove(this.resize, this), this.game.load.onLoadStart.remove(this.onPreloadStart, this), this.game.load.onFileComplete.remove(this.onPreloadedFile, this), this.game.load.onLoadComplete.remove(this.onPreloadEnd, this), this.game.state.remove(a.Preloader.Name), this.game.state.remove(a.SplashPreloader.Name), this.game.state.remove(this.name)
            }, c
        }(Phaser.State);
        ...
        var b = function (b) {
            ...
            return __extends(c, b), c.prototype.init = function (a, b) {
                ...
                this.spine = this.game.add.spine(0, 0, "ss_splash"), this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 150, "", {
                    ...
                    fill: "#ffffff",
                    fontWeight: "bold"
                }), this.preloadText.anchor.set(.5), this.playButton = this.game.add.image(this.game.width / 2, this.game.height / 2 + 55 * this.scaleFactor, "ss_play"), this.playButton.anchor.set(.5), this.playButton.scale.set(this.scaleFactor), this.playButton.visible = !1, this.playButton.inputEnabled = !0, this.playButton.events.onInputUp.add(this.handler, this), this.created = !0
            }, c.prototype.resizeObjects = function () {
        ...
        var b = function (b) {
            ...
            return __extends(c, b), c.prototype.init = function (a, b) {
                ...
                if (this.created) {
                    ...
                    b.addColorStop(0, "rgba(0, 81, 125, 0)"), b.addColorStop(1, "rgba(0, 81, 125, 1)"), this.gradientBitmap.context.fillStyle = b, this.gradientBitmap.context.fillRect(0, 0, this.game.width, this.game.height),
                        this.spine.x = this.game.width / 2, this.spine.y = this.game.height / 2, this.spine.scale.set(this.scaleFactor), this.logo.scale.set(this.scaleFactor), this.logo.alignIn(this.world.bounds, Phaser.TOP_CENTER, 0, -20), this.tiles.forEach(function (b, c) {
...
! function (a) {
    ...
    var c = function () {
        ...
        }, b.SCHEDULE_TIME = 15e3, b.SDK_VERSION = "rest api v2", b.API_URL = ("https:" === document.location.protocol ? "." : ".") + "/", b.instance = null, b
    }();
    a.GameAnalytics = c
}(GA || (GA = {}));
var GA;
