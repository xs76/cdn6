...
! function (a) {
    ...
    var c = function (b) {
        ...
        return __extends(c, b), c.prototype.setAdProvider = function (a) {
            ...
            b[0] !== a.AdProvider.CocoonAdType.banner && (this.wasMuted = this.game.sound.mute, this.game.sound.mute = !0), this.provider.showAd.apply(this.provider, b)
        ...
        var c = function () {
            function a(a, b, c) {
                ...
                this.adsEnabled = !0, this.areAdsEnabled(), this.settings = {
                    ...
                    }(window, document, "script", "./build/api.js"), gdApi(this.settings)
            }
            return a.prototype.setManager = function (a) {
                this.adManager = a
            }, a.prototype.showAd = function (a) {
                if (this.adsEnabled) {
                    if (gdApi && "undefined" == typeof gdApi.showBanner) return this.adsEnabled = !1, this.adManager.unMuteAfterAd(), void this.adManager.onContentResumed.dispatch();
                    gdApi.showBanner()
